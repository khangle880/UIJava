...
public class ctrlNavBar implements Initializable {
    ...
    private Image avt = new Image("home/resource/avt/love.jpg", false);
    ...
    public void handleAvtUpdate() {
        ctrlCropImage.avtImageProperty().addListener((observable, oldValue, newValue) -> {
            avt = newValue;
            UpdateAvtToScene();
